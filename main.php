         ...
         <section>
            <div class="container mt-5">
                <div class="flex-container">
                    <div class="flex-item">
                          <div class="h2" style="font-size: 4rem; text-decoration:bold; margin-top: 5rem; text-shadow: 2px 2px #ffffff; margin-right:14rem" > Crypto Quotient</div>
                        <div class="flex-item>">
                            <img src="/erc/images/undraw_stock_prices_re_js33.svg" alt="Homepage Main Image" class="main-img">
                            <div style="margin-top:3rem; font-size:2.25rem; margin-right:7rem;"class="p">Welcome to our gateway to digital wealth.</div>
                            <div  style="margin-top:-27rem; font-size:1.25rem; margin-right:6rem; word-break: break-all; " class="q"> At Crypto Quotient, we understand the fast-paced nature of the cryptocurrency market. That's why we've created a platform to help you navigate this exciting digital landscape with ease. Whether you're a seasoned trader or just starting out, Crypto Quotient is your ultimate companion for staying informed and making informed decisions.</div>
                        </div>
                    </div>
                </div>
            </div>
         </section>
         <!--this is for top coins section-->
         <section class="top-coins">
            <h1 class="text-centre"> Top Coins </h1>
...
<div class="tradingview-widget-container">
    ...
    "symbols": [
      {
        "description": "",
        "proName": "DEFILLAMA:ARBITRUM_TVL"
      },
      {
        "description": "",
